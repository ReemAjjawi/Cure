...
import 'package:cure/features/dash_sub.dart/lectures/lecture_post_model.dart';
import 'package:cure/features/dash_sub.dart/lectures/lecture_response_model_pdf.dart';
import 'package:cure/features/dash_sub.dart/lectures/presentation/lecture_response_model_audio.dart';
  ...
  Future<DataSuccessList<LectureModel>> getLectures(int subjectId) async {
    try {
      ...
      List<LectureModel> lectures = List.generate(
        ...
        (index) => LectureModel.fromJson(response.data[index]),
      );
  ...
  Future<DataSuccessObject<LectureModel>> addLecture(
    ...
    try {
      ...
      response = await dio.post(AppUrl.baseUrl + AppUrl.addLectures,
          options: HeaderConfig.getHeader(useToken: true),
          data: lecture.toMap());
      LectureModel lec = LectureModel.fromJson(response.data);
