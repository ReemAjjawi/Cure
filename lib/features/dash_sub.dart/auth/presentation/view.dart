...
import 'package:cure/features/dash_sub.dart/auth/model.dart';
import 'package:cure/features/dash_sub.dart/auth/presentation/bloc/login_bloc.dart';
                      ...
                      content: Text("error occured ${state.message}")));
                        ...
                        builder: (context, state) {
                          if (state is InitialStateLogIn) {
                            ...
                            return Text((state as LogInFailureState).message);
                          }
                        },
                      ),
                    ],
